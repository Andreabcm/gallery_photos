                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="color-label col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>
                                ...
                                <br>
                                <div class="form-group row">
                                    <label for="password-confirm" class="color-label col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
